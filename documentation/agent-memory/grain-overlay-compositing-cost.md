> Mirrors the `~/.claude/projects/D--SynoDrive-VSCN/memory/grain-overlay-compositing-cost.md` memory file; keep the two in sync.

---
name: grain-overlay-compositing-cost
description: "SHIPPED TO PROD 0a2a927 (PR #20): the shell is the VISUAL viewport now, not 100dvh; three guards were each found by a failing test"
metadata: 
  node_type: memory
  type: project
  originSessionId: 6e6d602f-5771-4d19-8959-541f3a03fac8
  modified: 2026-09-09T16:29:10.192Z
---
