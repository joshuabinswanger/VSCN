Mirrors `~/.claude/projects/D--SynoDrive-VSCN/memory/onboarding-closing-steps.md` — any Claude instance can read this copy directly without access to the user's profile.
