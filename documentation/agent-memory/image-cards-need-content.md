...
Consequence to keep in mind rather than argue with: at swap time `/community` renders
~21 typographic cards and no images, and it loses the 13 avatars the current simple card
