...
6. **96 placeholders generated, 48 distinct files referenced across 57 image slots.** The surplus is deliberate: it is what keeps motif repetition low once the stride picks images for 24 members holding 1–3 each. Not a leftover from the old fixed-four scheme.
