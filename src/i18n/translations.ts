export const ui: Record<string, Record<string, string>> = {
  en: {
    ...
    "auth.error.code.securityCheckBlocked":
      "Cloudflare Turnstile, the security check this site uses for logging in, could not load. If you use an ad blocker or a privacy extension, allow this site and reload the page. On an institutional network (ETH, UZH, another university, a hospital or a company) ask your IT department to allow challenges.cloudflare.com, or try again from another network.",
    ...
    "profile.note.languages": "Shown on your public profile. This does not change the website language.",
    "profile.label.correspondenceLanguage": "Correspondence language",
    "profile.note.correspondenceLanguage": "Used for community correspondence. This does not change the website language.",
  ...
  de: {
    ...
    "profile.note.languages": "Wird in deinem öffentlichen Profil angezeigt. Die Sprache der Website ändert sich dadurch nicht.",
    "profile.label.correspondenceLanguage": "Korrespondenzsprache",
    "profile.note.correspondenceLanguage": "Wird für Nachrichten aus der Community verwendet. Die Sprache der Website ändert sich dadurch nicht.",
